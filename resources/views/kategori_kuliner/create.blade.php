...
<head>
    <meta charset="UTF-8">
    <title>Tambah Kategori Kuliner - Kotabaru Tourism</title>
...
<body>
    ...
    <div class="header-section">
        <div class="container">
            <h1><i class="bi bi-plus-circle-fill me-2"></i>Tambah Kategori Kuliner</h1>
            <p>Buat kategori baru untuk mengklasifikasikan sentra kuliner</p>
        </div>
    </div>
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                ...
                <ul>
                    ...
                    <li>Kategori akan digunakan untuk <strong>mengelompokkan</strong> sentra kuliner</li>
                    <li>Satu sentra kuliner dapat memiliki <strong>lebih dari satu</strong> kategori</li>
                </ul>
            </div>

            <form method="POST" action="{{ route('kategori-kuliner.store') }}" id="kategoriForm">
                @csrf

                <div class="mb-4">
                    <label class="form-label">
                        <i class="bi bi-tag-fill"></i>
                        Nama Kategori Kuliner
                    ...
                    <div class="examples-box">
                        ...
                        <div class="example-tags">
                            <span class="example-tag">Makanan Tradisional</span>
                            <span class="example-tag">Makanan Modern</span>
                            <span class="example-tag">Seafood</span>
                            <span class="example-tag">Minuman</span>
                            <span class="example-tag">Kue & Bakery</span>
                            <span class="example-tag">Fast Food</span>
                            <span class="example-tag">Street Food</span>
                            <span class="example-tag">Fine Dining</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="button-group">
                    <a href="{{ route('kategori-kuliner.index') }}" class="btn-custom btn-back">
