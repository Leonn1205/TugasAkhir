...
<body>
    ...
    <div class="header-section">
        <div class="container text-center">
            <h1><i class="bi bi-list-ul me-2"></i>Daftar Tempat Wisata</h1>
        ...
        <div class="main-container">
            ...
            <div class="search-filter-bar">
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari nama wisata, kategori, atau lokasi..." onkeyup="searchTable()">
                </div>
                <select class="filter-select" id="filterKategori" onchange="filterTable()">
                    <option value="">Semua Kategori</option>
                    @foreach($wisata->pluck('kategori')->flatten()->unique('id_kategori') as $kat)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('wisata.show', $w->id_wisata) }}" class="btn-action btn-detail">
                                                <i class="bi bi-eye-fill"></i>
                                                Detail
                                            </a>
                                            <a href="{{ route('wisata.edit', $w->id_wisata) }}" class="btn-action btn-edit">
                                ...
                                <tr class="empty-row">
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <p>Mulai tambahkan data tempat wisata dengan klik tombol "Tambah Wisata" di atas</p>
                                            <a href="{{ route('wisata.create') }}" class="btn-custom btn-add">
                                                <i class="bi bi-plus-circle"></i>
